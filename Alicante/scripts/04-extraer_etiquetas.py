...
input_path = "../out/comparison_alicante"

print("Cargando los datos de los edificios...\n")
with open(os.path.join(input_path, 'name2identified_gdf_alicante.pickle'), 'rb') as handle:
...
output_file = "etiquetas_unicas_osm_alicante.txt"
